...
export const addWedgeScan = (viewer: any, active: boolean) => {
  if (active) {
    ...
    entity.push(viewer.entities.add({
      ...
      ellipsoid: {
        radii: new Cesium.Cartesian3(500000.0, 500000.0, 500000.0), //椭球的半径
        innerRadii: new Cesium.Cartesian3(1.0, 1.0, 1.0), //椭球内部的半径
        minimumClock: Cesium.Math.toRadians(0.0), //椭圆形的最小时钟角度
        maximumClock: Cesium.Math.toRadians(360.0), //椭圆形的最大时钟角度
        minimumCone: Cesium.Math.toRadians(90.0), //椭圆体的最小锥角
        maximumCone: Cesium.Math.toRadians(95.0), //椭圆体的最大锥角
